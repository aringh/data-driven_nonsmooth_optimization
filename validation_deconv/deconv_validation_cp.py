...
with tf.name_scope('variable_definitions'):
    sigma_one = tf.Variable(tf.constant(0.99796641, dtype=tf.float32),
                            name='sigma_one')
    sigma_two = tf.Variable(tf.constant(1.16901743, dtype=tf.float32),
                            name='sigma_two')
    tau = tf.Variable(tf.constant(3.01211762, dtype=tf.float32),
                      name='tau')
    theta = tf.Variable(tf.constant(0.16770093, dtype=tf.float32),
                        name='theta')
...
x_true_odl.show(saveto=save_path + 'phantom')
